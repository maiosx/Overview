...
var PLUGIN_ID = "io.github.overview"
var SUPER = 64
var SHIFT = 1
var CTRL = 4
var ALT = 8
...
var CANDIDATES = [
    {
        ...
        key: "F",
        desc: "Overview",
        cmd: "omarchy-shell shell toggle io.github.overview '{}'",
        alternates: [
...
function hyprKeywordArg(item) {
    ...
    var mods = parts.join(" ")
    var cmd = String(item.cmd || "omarchy-shell shell toggle io.github.overview '{}'")
